...
export const HeroSection = () => {
  return <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    shouldOrbit orbitDuration='30s'
    shouldSpin spinDuration='3s'>
    <SparkleIcon className="size-8 text-emerald-300/20"  />
    </HeroOrbit>
    <HeroOrbit size={440} rotation={79}
    shouldOrbit orbitDuration='32s'
    shouldSpin spinDuration='3s'>
    ...
    shouldOrbit orbitDuration='48s'
    shouldSpin spinDuration='6s'>
    <StartIcon className="size-28 text-emerald-300 "/>
    </HeroOrbit>
    </div>
    <div className="container relative z-10"> {/* Ensure content is above overlays */}
      <div className='flex flex-col items-center'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
            <button 
              className='inline-flex items-center border border-white/15 px-6 h-12 rounded-xl'
              onClick={() => {
